...
/**
 * 
 * 					Document type for the definition of a column set, which is a set of code
 * 					list
 * 					columns and/or keys.
 * 				
 * 
...
public class ColumnSetDocument {
     ...
     * 						Gets the value of the columnChoice property.
     * 
     * <p>
     ...
     * 						Gets the value of the keyChoice property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     ...
     * 						
     * <pre>
     * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;rule:text xmlns:rule="http://docs.oasis-open.org/codelist/ns/rule/1.0/" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" category="application" id="R16"&gt;xml:base does not apply to
     * 							canonical URIs.
     * 						&lt;/rule:text&gt;
     * </pre>
     * 
