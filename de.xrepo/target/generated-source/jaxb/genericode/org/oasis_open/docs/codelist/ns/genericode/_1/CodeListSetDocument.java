...
public class CodeListSetDocument {
    ...
    /**
     * 
     * 							Contents of the code list set. If the code list set does not have any
     * 							contents, it is a CodeListSet Metadata definition.
     * 						Gets the value of the codeListSetChoice property.
     * 
     * <p>
     ...
     * 						
     * <pre>
     * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;rule:text xmlns:rule="http://docs.oasis-open.org/codelist/ns/rule/1.0/" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" category="application" id="R11"&gt;xml:base does not apply to
     * 							canonical URIs.
     * 						&lt;/rule:text&gt;
     * </pre>
     * 
