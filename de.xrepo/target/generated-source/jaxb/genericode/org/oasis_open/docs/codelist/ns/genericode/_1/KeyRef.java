 ...
 * 					
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;rule:text xmlns:rule="http://docs.oasis-open.org/codelist/ns/rule/1.0/" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" category="application" id="R35"&gt;
 * 						The key reference must be valid. An application may use the
 * 						CanonicalVersionUri to select a local copy of the code list or
 * 						column set which contains the key definition. Otherwise the
 * 						LocationUri value(s) may be tried in order, until a valid code
 * 						list
 * 						or column set document (containing the necessary key definition) is
 * 						retrieved. An application must signal an error to the user if it
 * 						is
 * 						not able to retrieve a code list or column set document which
 * 						contains the necessary key definition.
 * 					&lt;/rule:text&gt;
 * </pre>
 * 
 * 				
...
public class KeyRef {
     ...
     * 						
     * <pre>
     * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;rule:text xmlns:rule="http://docs.oasis-open.org/codelist/ns/rule/1.0/" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" category="application" id="R36"&gt;xml:base does not apply to
     * 							canonical URIs.
     * 						&lt;/rule:text&gt;
     * </pre>
     * 
