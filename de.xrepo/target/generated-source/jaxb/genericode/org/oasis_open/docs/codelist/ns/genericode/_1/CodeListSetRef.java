 ...
 * 					
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;rule:text xmlns:rule="http://docs.oasis-open.org/codelist/ns/rule/1.0/" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" category="application" id="R47"&gt;
 * 						The code list set reference must be valid. An application may use the
 * 						CanonicalVersionUri to select a local copy of the code list set.
 * 						If
 * 						there is no CanonicalVersionUri, the CanonicalUri may be used to
 * 						select a local copy of the code list set. Otherwise the LocationUri
 * 						value(s) may be tried in order, until a valid code list set
 * 						document
 * 						is retrieved. An application must signal an error to the user if it
 * 						is not able to retrieve a code list set document to match the code
 * 						list set reference.
 * 					&lt;/rule:text&gt;
 * </pre>
 * 
...
public class CodeListSetRef {
     ...
     * 						
     * <pre>
     * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;rule:text xmlns:rule="http://docs.oasis-open.org/codelist/ns/rule/1.0/" xmlns:gc="http://docs.oasis-open.org/codelist/ns/genericode/1.0/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" category="application" id="R54"&gt;xml:base does not apply to
     * 							canonical URIs.
     * 						&lt;/rule:text&gt;
     * </pre>
     * 
